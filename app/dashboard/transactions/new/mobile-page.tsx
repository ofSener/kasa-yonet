...
export default function MobileNewTransactionPage() {
  ...
  // If not mobile, redirect to regular page or show desktop version
  if (!isMobile) {
    return null
  }
  ...
  return (
    <div className="space-y-6">
      ...
      {categories.length === 0 && (
        <div className="bg-white rounded-xl p-6 border border-gray-100 shadow-sm text-center text-gray-500 space-y-2">
